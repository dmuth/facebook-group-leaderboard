...
function checkConfigCrowds(config) {
	return(new Promise(function(resolve, reject) {
		...
		if ( !config.crowds || !keys.length ) {
			...
			console.log("# ");
			console.log("# Configuration should be stored in config/local.json");
			console.log("# ");
		...
		console.log("# ");
		console.log("# Configuration should be stored in config/local.json");
		console.log("# The ID of the group you'd like to monitor can be found at https://lookup-id.com/");
		console.log("# ");
	...
	*/ 
	go: function(config, tokens, cb) {
		...
		checkConfig(config).then(function() {
			...
			console.log("#");
			console.log("# Everything checks out!  Have fun! :-)");
			console.log("#");
